...
public class SamlConfiguration {
	...
	public List<SamlMessageHandler> handlers(SamlServerConfiguration configuration) {
      ...
      artifactSpResponseHandler(configuration)
		);
	}
	...
	public Defaults defaults() {
		return new Defaults(time()) {
			@Override
			public AuthenticationRequest authenticationRequest(ServiceProviderMetadata sp,
					IdentityProviderMetadata idp) {
        AuthenticationRequest authenticationRequest = super.authenticationRequest(sp, idp);
